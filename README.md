...
## Getting Started
1. **Get API Key**
   - Subscribe via your preferred marketplace: [API.Market](https://api.market/store/osint-trace-1/instagram-checker) or [RapidAPI Hub](https://rapidapi.com/osint-org-osint-org-default/api/instagram-checker)
...
2. **Base URL & Authentication**
   ...
   **API.Market:**
   - Base URL: `https://prod.api.market/api/v1/osint-trace-1/instagram-checker`
   - Header: `X-Api-Key`

   **RapidAPI:**
   - Base URL: `https://instagram-checker.p.rapidapi.com`
   - Headers: `X-RapidAPI-Host: instagram-checker.p.rapidapi.com` and `X-RapidAPI-Key`
...
## Pricing
Flexible plans available through [API.Market](https://api.market/store/osint-trace-1/instagram-checker) or [RapidAPI](https://rapidapi.com/osint-org-osint-org-default/api/instagram-checker/pricing).   

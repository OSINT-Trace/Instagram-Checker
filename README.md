...
[![RapidAPI Badge](https://img.shields.io/badge/Available%20on-RapidAPI-black?style=for-the-badge&logo=rapidapi)](https://rapidapi.com/osint-org-osint-org-default/api/instagram-checker)
...
## Getting Started
1. **Get API Key**
   - Subscribe via [RapidAPI Hub](https://rapidapi.com/osint-org-osint-org-default/api/instagram-checker)
   - Get your `X-RapidAPI-Key` from your dashboard

2. **Base URL**
```text
https://instagram-checker.p.rapidapi.com
```
## API Endpoints
...
url = "https://instagram-checker.p.rapidapi.com/check_bulk"
payload = {"input": ["test@example.com", "instagramuser123", "+19295551234"]}
headers = {
...
## Pricing
Flexible plans available through [RapidAPI](https://rapidapi.com/osint-org-osint-org-default/api/instagram-checker/pricing).   
